...
def get_transcript_text(transcript_id):
    ...
    # Use a pre-trained model like BERT to calculate the similarity between the question and the text
    # You can use the 'cosine_similarity' or 'dot_product' of the embeddings
    # Here, we'll use a simple example where we calculate the number of overlapping words
